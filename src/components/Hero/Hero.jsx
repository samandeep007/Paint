export default function Hero() {
  return (
    ...
    <div className="bg-gradient-to-tr from-black via-black to-fuchsia-900 w-full h-[100vh]  bg-opacity-50 backdrop-blur object-contain overflow-y-hidden">
        ...
        <h1 className="text-white text-7xl font-bold max-w-4xl pl-12 mt-24">Transform Your Lawn with the <span className="text-transparent bg-clip-text bg-gradient-to-tr  from-gray-200 via-pink-300 to-pink-800">Perfect Cut</span> Every Time!</h1>
        ...
        <img src="./assets/room.png" className="relative max-w-3xl mt-36 scale-110 mr-10" alt="" />
