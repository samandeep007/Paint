      ...
      <div className="max-w-8xl flex flex-col lg:flex-row items-center justify-center mx-auto mt-10 px-4 lg:px-0">
        <div className="lg:max-w-1/2 h-auto text-center lg:text-left">
          ...
          <p className="text-white text-lg sm:text-xl lg:text-2xl max-w-3xl font-semibold lg:pl-12 pt-6 lg:pt-10 pb-0">
            Say goodbye to overgrown grass and hello to a beautifully maintained lawn. Our professional lawn mowing services bring out the best in your yard, giving you more time to relax and enjoy the outdoors. Book a service today and see the difference!
          </p>
        </div>
        ...
        <img
          ...
          alt="Lawn transformation illustration"
        />
      </div>
    </div>
  );
