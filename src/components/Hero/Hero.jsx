export default function Hero() {
  return (
    <>
    <div className="bg-gradient-to-tr from-black via-black to-yellow-700 w-full h-[100vh] flex items-center justify-center bg-opacity-50 backdrop-blur object-contain overflow-y-hidden">
        ...
        <img src="./assets/home.png" className="relative  max-w-3xl mt-5 scale-120 mr-8" alt="" />
        {/* <img src="./assets/home.png" className="absolute max-w-3xl mt-5 scale-120" alt="" /> */}
    </div>
    </>
  )
}
