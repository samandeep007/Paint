export default function Hero() {
  return (
    <>
    <div className="bg-gradient-to-tr from-black via-black to-fuchsia-900 w-full h-[100vh] flex items-center justify-center bg-opacity-50 backdrop-blur object-contain overflow-y-hidden">
