const services = [
    ...
    },
    {
      ...
      imageUrl: "./assets/snowRemoval.webp",
    },
    {
      ...
      imageUrl: "./assets/irrigation.webp",
    },
    {
      title: "Tree Trimming",
      description:
      ...
      imageUrl: "./assets/treeTrimming.webp",
    },
  ];
  ...
  const Services = () => {
    return (
      <>
      <section  className="w-full bg-gradient-to-tr from-black via-black to-green-900 h-32"></section>
        <section className="w-full h-auto bg-gradient-to-bl from-black via-black to-green-900 flex flex-col items-center py-16 px-8 text-white">
            ...
            {services.map((service, index) => (
              ...
              >
                ...
                <div className="flex-1 text-center md:text-left">
                  <h1 className="text-5xl font-bold mb-4 text-transparent mx-2 bg-clip-text bg-gradient-to-tr from-gray-200 via-green-300 to-green-800">
                    {service.title}
                  </h1>
